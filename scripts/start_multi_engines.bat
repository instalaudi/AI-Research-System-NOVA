...
set OLLAMA_HOST_1=11434
set OLLAMA_HOST_2=11435
set OLLAMA_HOST_3=11436

:: Motor 1: Chat/General (Puerto 11434) - Núcleos 0-3 (Afinidad 0F)
...
:: Motor 2: Developer (Puerto 11435) - Núcleos 4-7 (Afinidad F0)
...
:: Motor 3: Auditoria/Vision (Puerto 11436) - Núcleos 0-7 (Afinidad FF - Compartido)
